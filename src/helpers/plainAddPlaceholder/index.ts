 ...
 */
export function plainAddPlaceholder(opts: PlainAddPlaceholderOpts): Buffer {
    const { pdfBuffer, reason, signatureLength } = { signatureLength: DEFAULT_SIGNATURE_LENGTH, ...opts };
    ...
    const pdfKitMock = {
        ref: (input: any, additionalIndex?: number) => {
